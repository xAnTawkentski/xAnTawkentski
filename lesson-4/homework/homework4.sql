...
--Task 14
SELECT * FROM Employees WHERE (Age BETWEEN 30 AND 40) OR (
...
VALUES (1, 1, 1, '2023-01-01', 150.00), 
...
FROM Products
WHERE Price < (SELECT AVG(Price)*0.1 
FROM Products);

--Task 24
SELECT * FROM Employees
WHERE AGE > 30 AND
(DepartmentName = 'HR' OR
DepartmentName = 'IT');
...
DATEADD(DAY, -180, GETDATE()) AND GETDATE();
